...
public class LoginAsUser implements Task{
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                WaitUntil.the(N11LoginPageElements.FACEBOOK_LOGIN_BTN,isClickable())
                ...
                Switch.toNewWindow(),
                WaitUntil.the(N11UserMainPageElements.CONTRACT_CHECK_BOX,isClickable())
                        .forNoMoreThan(5).seconds(),
                ...
                WaitUntil.the(N11UserMainPageElements.USER_ACC_LINK,isClickable())
                        .forNoMoreThan(5).seconds()
        );
    }
